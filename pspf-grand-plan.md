...
The programme specification is the 2026-09-19 commitment-led operating model technical specification (`.hermes/plans/2026-09-19_091633-commitment-led-operating-model-techspec.md`, status aspirational). Its repository observations were verified against `develop` on 2026-09-19. [ADR 0099](adr/0099-commitment-led-operating-model-phase-0-baseline.md) is the accepted Phase 0 decision record; the detailed phase plan is [docs/commitment-operating-model-plan.md](docs/commitment-operating-model-plan.md). Phase 1 (explicit working-context presentation plus the `planningState`/history semantic-debt fixes) is authorised but not yet implemented.
