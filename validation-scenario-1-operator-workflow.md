...
2. Open the PSPF Workshop Activity Bar item and confirm `Workshop Home` appears with `PSPF v1.36.1`, `Schema 1.12.0`, and `API 1.12.0`.
3. Confirm the VS Code status bar shows `PSPF v1.36.1` and its tooltip includes `Schema 1.12.0`, `Bundle 1.12.0`, and `API 1.12.0`.
