...
2. Open the PSPF Workshop Activity Bar item and confirm `Workshop Home` appears with `PSPF v1.63.0`, `Schema 1.15.0`, and `API 1.15.0`.
3. Confirm the VS Code status bar shows `PSPF v1.63.0` and its tooltip includes `Schema 1.15.0`, `Bundle 1.15.0`, and `API 1.15.0`.
