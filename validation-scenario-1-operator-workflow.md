...
Still out of scope for v1.27.0:
...
2. Open the PSPF Workshop Activity Bar item and confirm `Workshop Home` appears with `PSPF v1.27.0`, `Schema 1.10.0`, and `API 1.10.0`.
3. Confirm the VS Code status bar shows `PSPF v1.27.0` and its tooltip includes `Schema 1.10.0`, `Bundle 1.10.0`, and `API 1.10.0`.
...
- A readiness report at `.tmp/release-readiness/v1.27.0-readiness-report.md`.
