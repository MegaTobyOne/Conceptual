# Validation Scenario 1: v1.42.0 UX, Pub Team Planning, and Cyber Reference Dataset Workflow
...
Still out of scope for v1.42.0:
...
2. Open the PSPF Workshop Activity Bar item and confirm `Workshop Home` appears with `PSPF v1.42.0`, `Schema 1.14.0`, and `API 1.14.0`.
3. Confirm the VS Code status bar shows `PSPF v1.42.0` and its tooltip includes `Schema 1.14.0`, `Bundle 1.14.0`, and `API 1.14.0`.
...
- A readiness report at `.tmp/release-readiness/v1.42.0-readiness-report.md`.
