...
2. Open the PSPF Workshop Activity Bar item and confirm `Workshop Home` appears with `PSPF v1.16.0`, `Schema 1.8.0`, and `API 1.8.0`.
3. Confirm the VS Code status bar shows `PSPF v1.16.0` and its tooltip includes `Schema 1.8.0`, `Bundle 1.8.0`, and `API 1.8.0`.
