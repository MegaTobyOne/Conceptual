...
- **v1.4 validation build**: local Risks, local status conflict display, and the existing Explorer-to-Workshop round-trip gates.
- **v1.5 candidate**: `plan-apply`, conflict classification, review pane, and per-import undo.
- **v1.6 candidate**: tags, saved views, and compliance-history export controls after the local-authoring loop is stable.
