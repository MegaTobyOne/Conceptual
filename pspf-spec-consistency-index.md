...
- **v1.6.0 validation build**: Workshop import review surface for Explorer local JSON, Workshop system-of-record identity, Explorer/Workshop product-boundary decision, Explorer identity pass, remembered-bundle refresh restore, `plan-apply`, conflict classification, explicit apply confirmation, and last-import undo.
- **v1.6 candidate**: richer graphical import review, tags, saved views, and compliance-history export controls after the local-authoring loop is stable.
