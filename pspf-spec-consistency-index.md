...
- **v1.5.1 validation build**: Explorer/Workshop product-boundary decision, Explorer identity pass, remembered-bundle refresh restore, `plan-apply`, conflict classification, explicit apply confirmation, and last-import undo.
