...
.hero{border-left:4px solid #c45a64;padding:14px 16px;background:color-mix(in srgb,var(--vscode-editor-background) 88%,#c45a64 12%)}h1,h2,p{margin:0}.hero p{margin-top:6px;max-width:78ch}.toolbar,.filters,.tabs{display:flex;gap:8px;flex-wrap:wrap;align-items:end;margin-top:14px}.toolbar button,.tabs button,.route{width:auto;min-height:36px}.filters{padding:12px 0;border-bottom:1px solid var(--vscode-panel-border)}.field{display:grid;gap:4px}.field select{min-width:190px;padding:7px}.check{display:flex;gap:6px;align-items:center;min-height:34px}.tabs{position:sticky;top:0;z-index:2;padding:10px 0;background:var(--vscode-editor-background)}.tabs button[aria-selected="true"]{border-bottom:3px solid #c45a64}.view{margin-top:18px}.view[hidden]{display:none}.metrics{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:8px;margin:16px 0}.metric{border-left:3px solid #c45a64;padding:10px 12px;background:var(--vscode-sideBar-background)}.metric strong{display:block;font-size:1.45rem}.table-wrap{overflow:auto;border:1px solid var(--vscode-panel-border);margin-top:10px}table{width:100%;border-collapse:collapse;min-width:720px}th,td{text-align:left;padding:9px;border-bottom:1px solid var(--vscode-panel-border)}th{background:var(--vscode-sideBar-background)}.status,.severity{white-space:nowrap;font-weight:600}.severity-critical{color:var(--vscode-testing-iconFailed)}.severity-high{color:var(--vscode-editorWarning-foreground)}.subsection{margin-top:24px}.muted{color:var(--vscode-descriptionForeground)}button:focus-visible,select:focus-visible,input:focus-visible{outline:2px solid var(--vscode-focusBorder);outline-offset:2px}@media(max-width:700px){body{padding:12px}.tabs{position:static}.tabs button{flex:1 1 140px}}
