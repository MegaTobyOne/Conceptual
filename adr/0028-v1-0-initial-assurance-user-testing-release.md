...
v0.9 completed the release-candidate freeze: no new product features, refreshed manual validation, active-version readiness reporting, and release-candidate consistency checks. The automated gates and manual scenario now cover the full v1.0 validation surface.
...
1. v1.0 is a release cut from v0.9 with no additional product features.
...
- `check:release-candidate` validates `1.0.0` versions, `1.3.0` compatibility axes, v1.0 scripts/docs, manual scenario coverage, and Shop/Pub deferrals.
- `release:readiness` must pass 15/15 tracked gates and write the v1.0 readiness report.
- The manual scenario must show `PSPF v1.0.0` and `Schema/Bundle/API 1.3.0` in Workshop/Explorer surfaces.
