...
This repository implements the PSPF product ecosystem at v1.43.0: four VS Code extensions, a static Explorer web app, shared packages, schemas, release tooling, and governing specifications. Keep agent guidance concise and link to the specs rather than repeating them.
...
- Current repo version: `1.43.0`; all workspace packages are expected to remain version-aligned.
