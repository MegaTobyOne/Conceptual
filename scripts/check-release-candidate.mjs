              ...
              : minorVersion >= 54
                ...
                : minorVersion >= 53
                  ...
                  : minorVersion >= 52
                    ? "e2e:v1.52"
                    : minorVersion >= 48
                      ? `e2e:v1.${Math.min(minorVersion, 50)}`
                      : minorVersion >= 47
                        ? "e2e:v1.47"
                        : minorVersion >= 46
                          ? "e2e:v1.46"
...
if (isV1Release && minorVersion >= 33) {
  const v133Adr = await readFile(join(root, "adr/0075-questionnaire-population.md"), "utf8");
  for (const requiredText of [
...
if (isV1Release && minorVersion >= 44) {
  ...
  const workshopExtension = await readFile(join(root, "packages/workshop/src/extension.ts"), "utf8");
  for (const requiredText of ["buildStrategyPrioritySummary", "Priority logic", "bandLabel"]) {
    assert.equal(
      workshopExtension.includes(requiredText),
      true,
