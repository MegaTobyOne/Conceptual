...
The repository currently ships PSPF v1.19.0 with Core, Workshop, Shop, and Explorer. The active compatibility axes are `schemaVersion`, `bundleVersion`, and `apiVersion` `1.8.0`.
...
`release:readiness` runs the v1.19 gate chain and writes `.tmp/release-readiness/v1.19.0-readiness-report.md`.
