...
The repository currently ships PSPF v1.31.1 with Core, Workshop, Shop, Pub, and Explorer. The active compatibility axes are `schemaVersion`, `bundleVersion`, and `apiVersion` `1.11.0`.
...
`release:readiness` runs the v1.31 gate chain and writes `.tmp/release-readiness/v1.31.1-readiness-report.md`.
