...
The repository currently ships PSPF v1.24.2 with Core, Workshop, Shop, and Explorer. The active compatibility axes are `schemaVersion`, `bundleVersion`, and `apiVersion` `1.10.0`.
...
`release:readiness` runs the v1.24 gate chain and writes `.tmp/release-readiness/v1.24.2-readiness-report.md`.
